      ...
      <div className="hidden left-0 top-[35%] lg:flex flex-col fixed">
        <ul>
          <li className="ml-[-100px] hover:ml-[-10px] flex flex-col duration-300 justify-center items-center w-[160px] h-[60px] bg-blue-500 ">
            <a className="flex justify-between w-full items-center" href="https://www.linkedin.com/in/abhishek-gola-0a98a5212/" target="_blank" rel="noreferrer">Linkedin <FaLinkedin size={30} /></a>
          </li>
          <li className="ml-[-100px] hover:ml-[-10px] flex flex-col duration-300 justify-center items-center w-[160px] h-[60px] bg-[#333333] ">
            <a className="flex justify-between w-full items-center" href="https://github.com/Abhi-gola" target="_blank" rel="noreferrer">GitHub <FaGithub size={30} /></a>
          </li>
          <li className="ml-[-100px] hover:ml-[-10px] flex flex-col duration-300 justify-center items-center w-[160px] h-[60px] bg-[#6fc2b0] ">
            <a className="flex justify-between w-full items-center" href="mailto:abhishekg5422@gmail.com" target="_blank" rel="noreferrer">Email <HiOutlineMail size={30} /></a>
          </li>
          <li className="ml-[-100px] hover:ml-[-10px] flex flex-col duration-300 justify-center items-center w-[160px] h-[60px] bg-[#565f69] ">
            <a className="flex justify-between w-full items-center" href="https://drive.google.com/file/d/1eYvYWtlZXBuZiFDBBNOKWcPaMMR2X8oc/view?usp=sharing" target="_blank" rel="noreferrer">Resume <BsFillPersonLinesFill size={30} /></a>
          </li>
        </ul>
      </div>
    </div>
